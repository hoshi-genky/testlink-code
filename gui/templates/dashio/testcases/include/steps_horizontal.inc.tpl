...
*}
  ...
  <tr id="step_row_{$step_info.step_number}">
    ...
    <td {if $edit_enabled && $args_frozen_version=="no"} style="cursor:pointer;" class="clickable_edit" onclick="launchEditStep({$step_info.id})" 
        {else}
            class="display_actions td_steps_horizontal_inc"
        {/if}>
    ...
    <td {if $edit_enabled && $args_frozen_version=="no"} style="cursor:pointer;" class="clickable_edit" onclick="launchEditStep({$step_info.id})" 
        {else}
            class="display_expected_results td_steps_horizontal_inc"
        {/if}>
        {if $gui->stepDesignEditorType == 'none'}
    ...
    {if $gui->tprojOpt->automationEnabled}
      <td {if $edit_enabled && $args_frozen_version=="no"} style="cursor:pointer;" class="clickable_edit" onclick="launchEditStep({$step_info.id})" {/if}>
          {$gui->execution_types[$step_info.execution_type]}
      </td>
    {/if}
